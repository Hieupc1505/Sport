...
import list from "~/components/GlobelStyles/type.json";
import { v4 as uuidv4 } from "uuid";
import { useDispatch } from "react-redux";
import { changeNation } from "~/redux/actions";
import { useStateCustom } from "~/components/Hooks";
...
const Header = () => {
    const { loading, nation } = useSelector((state) => state.sport);
